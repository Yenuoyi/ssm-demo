...
<tr>
<td align="center">原密码: <input type="password" id="old_password" name="old_password" maxlength="20"></td>
</tr>
<tr>
<td align="center">新密码:<input type="password" id="new_password" name="new_password" maxlength="20"/></td>
</tr>
<tr>
<td align="center">确认新密码:<input type="password" id="sure_password"  name="sure_password" maxlength="20"/></td>
</tr>
<tr>
<td align="center">
<input type= "button" value="提交更改信息" onclick="CheckAll()">
</td>
</tr>
</table>
</form>
